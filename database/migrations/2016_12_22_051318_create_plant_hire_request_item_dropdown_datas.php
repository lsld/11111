...
class CreatePlantHireRequestItemDropdownDatas extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('plant_hire_request_item_dropdown_datas', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('plant_hire_request_item_dropdown_datas');
    }
}
