...
<div class="page-content-wrapper portal supplier-portal-company-profile">
    ...
    <div class="page-content">
        ...
        <div class="wrap-ccf-form">
            ...
            @if($company->isOwner())
                {{--s-MODAL CONTACTS DETAILS--}}
                <div class="modal fade" id="modalContactDetails" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('company.profile.update_contact_details') }}" name="contact_details" method="POST">
                            {{ method_field('PUT') }}
                            {{ csrf_field() }}
                            <div class="modal-content">
                                <div class="modal-header">
                ...
                {{--e-MODAL CONTACTS DETAILS--}}
            @endif

        <div class="modal fade" id="testm" tabindex="-1" role="basic" aria-hidden="true">
                    <div class="modal-dialog">
                    <div class="sweet-alert  showSweetAlert visible" tabindex="-1" data-custom-class="" data-has-cancel-button="false" data-has-confirm-button="true" data-allow-outside-click="true" data-has-done-function="true" data-animation="pop" data-timer="null" style="display: block; margin-top:0;margin-left: -230px"><div class="sa-icon sa-error animateErrorIcon" style="display: block;">
                        ...
                        <p class="lead text-muted " style="display: block;">Error Icon</p>
                        <div class="form-group">
                          ...
                          <div class="sa-confirm-button-container">
                            <button class="confirm btn btn-lg btn-danger" tabindex="1" style="display: inline-block;">OK</button><div class="la-ball-fall">
                              <div></div>
                              <div></div>
                              <div></div>
                            </div>
                                        ...
                                        <div class="row">
                                           <div class="col-md-4">
                                               <h5>
                                                   ...
                                                   <strong>Operating Categories</strong></h5>
                                           </div>
                                           <div class="col-md-8">
                                               <p>
                                                   @if($company->profile->operating != null)
