                    ...
                    <div class="form-body">
                        <div class="table-responsive">
                            <table class="table table-striped">
                                ...
                                @if(!empty($QuotesTableData))
                                    <tbody>
                                    @foreach($QuotesTableData as $QuotesTableDataItem)
                                        <script type="text/javascript">
                                        </script>
                                        <tr>
                                            <td>{{$QuotesTableDataItem->JobRequest->id }}</td>
                                            <td>{{$QuotesTableDataItem->code }}</td>
                                            <td>{{$QuotesTableDataItem->price }}</td>
                                            <td>{{$QuotesTableDataItem->created_at }}</td>
                                            <td>{{$QuotesTableDataItem->expiry_date }}</td>
                                            <td>{{$QuotesTableDataItem->JobRequest->expiry_date }}</td>
                                            <td class="status-shown"><span class="color-view bg-purple-seance bg-font-purple-seance">{{$QuotesTableDataItem->status}}</span></td>
                                            <td>
                                                <a  href="{{ route('show_supplier_quote', $QuotesTableDataItem->id)}}"  class="btn btn-xs btn-default" title="View" data-toggle="modal"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
